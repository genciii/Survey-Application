...
public class RadyoDugmesi extends Activity {
	RadioButton ra1, r2, r3, r4, rra1, rr2, rr3, rr4, rrra1, rrr2, rrr3, rrr4,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_radyo_dugmesi);
		...
		rra1 = (RadioButton) findViewById(R.id.rra1);
		rr2 = (RadioButton) findViewById(R.id.rr2);
		rr3 = (RadioButton) findViewById(R.id.rr3);
		rr4 = (RadioButton) findViewById(R.id.rr4);
		rrra1 = (RadioButton) findViewById(R.id.rrra1);
		rrr2 = (RadioButton) findViewById(R.id.rrr2);
		rrr3 = (RadioButton) findViewById(R.id.rrr3);
		rrr4 = (RadioButton) findViewById(R.id.rrr4);
		rrrra1 = (RadioButton) findViewById(R.id.rrrra1);
		rrrr2 = (RadioButton) findViewById(R.id.rrrr2);
		rrrr3 = (RadioButton) findViewById(R.id.rrrr3);
		rrrr4 = (RadioButton) findViewById(R.id.rrrr4);
		rrrrra1 = (RadioButton) findViewById(R.id.rrrrra1);
		rrrrr2 = (RadioButton) findViewById(R.id.rrrrr2);
		rrrrr3 = (RadioButton) findViewById(R.id.rrrrr3);
		rrrrr4 = (RadioButton) findViewById(R.id.rrrrr4);
